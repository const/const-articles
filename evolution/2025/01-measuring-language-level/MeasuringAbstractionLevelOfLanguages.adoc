...
The research was initially inspired by observed parallels between programming language groups and stages in https://en.wikipedia.org/wiki/Piaget%27s_theory_of_cognitive_development[J. Piaget's theory of cognitive development]. Later, the https://en.wikipedia.org/wiki/Model_of_hierarchical_complexity[Model of hierarchical complexity by M. Commons] was added to the mix. While J. Piaget considered the development of human reasoning as a whole, M. Commons noted that advancement through stages is uneven across different domains.

These models served as a **discovery heuristic** that guided the initial search for connection types and reasoning boundaries. However, developmental psychology is descriptive and bound to human maturation; it does not provide formal or empirical validation for language design. The framework extracts the abstract progression of reasoning complexity from those models and rebuilds it on programming semantics and connection topology. The levels stand on their technical merits; the psychological references remain a short side note documenting the origin of the idea.
