...
v0.1.1, 2026-04-30: Minor improvement
:toc:
:sectnums:
...
*TL;DR:* TL;DR: A single global DI context (like Spring’s ApplicationContext) creates naming conflicts, hidden dependencies, and poor reusability – a “primordial soup”. Better isolation (e.g., OSGi) or hierarchical composition (e.g., UI frameworks) avoids this. A new language with native system operators is needed (details in future work).
